...
const Experience = () => {
  ...
  const experience = calculateExperience("2024-07-27");

  const workExperience = [
    { title: "Software Trainee", tasks: "Crud operations", period: "November 2024 - Present" },
    { title: "Software Intern", tasks: "Crud operations", period: "July 2024 - October 2024" }
  ];

  const internships = [
    { title: "Software Developer", company: "IMFU Tech, Pudukkottai.", period: "February 2024 - March 2024" },
    { title: "Java & Selenium Internship in testing", company: "Moolya Ed.", period: "July 2023" },
    { title: "Cyber Security Program", company: "Verzeo", period: "January 2023 - February 2023" }
  ];
